...
import VueSchoolCTA from "../../../components/VueSchoolCTA.astro";
import { Aside } from "@astrojs/starlight/components";

<Aside type="tip" title="API Preference">
  ...
  <span class="options-api">Options API</span>
  <span class="composition-api">Composition API</span>. You can toggle between the
  API styles using the "API Preference" switches at the top of the left sidebar.
</Aside>
...
>
  Learn Vue 3 the right way — watch a free video!
</VueSchoolCTA>
